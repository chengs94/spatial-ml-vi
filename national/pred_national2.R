...
load("/home/users/chengsi/Desktop/exposurepred/spatRF/syn.RData")
load("/home/users/chengsi/Desktop/exposurepred/spatRF/syn_rslt.RData")
...
# annavg <- sqrt(annavg)
annavg = y.err + y.mean - min(y.err + y.mean)
n <- length(annavg)
...
save.image("varimp_syn_full.RData")
save(X, annavg, plltnt.mat, rslt.syn, file = "varimp_syn.RData")

# save.image("varimp_seed3_s_full.RData")
# save(X, annavg, plltnt.mat, rslt.s, file = "varimp_seed3_s.RData")
